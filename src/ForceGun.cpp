...
void ForceGun::OnUpdate()
{
}

void ForceGun::OnSerialize(Serializer &sav)
{
	UNUSED(sav);
}
...
ForceGun::ForceGun(const shared_ptr<Location> &location) : Weapon(location, ItemType::Weapon_Harpoon)
{
...
bool ForceGun::Shoot(const Vec2f &direction)
{
